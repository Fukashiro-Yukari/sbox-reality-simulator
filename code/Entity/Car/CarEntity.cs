...
public partial class CarEntity : Prop, IUse
{
	...
	protected void Tick()
	{
		if ( Driver is RealityPlayer player && player.LifeState != LifeState.Alive )
		{
			RemoveDriver( player );
		}
	}
	...
	void SimulateDriver( Client client )
	{
		...
		{
			RemoveDriver( Driver as RealityPlayer );
			return;
		}
	...
	{
		if ( user is RealityPlayer player && timeSinceDriverLeft > 1.0f )
		{
			player.Parent = this;
	...
	public override void StartTouch( Entity other )
	{
		...
		if ( other is RealityPlayer player )
		{
	...
	protected override void OnPhysicsCollision( CollisionEventData eventData )
	{
		...
		if ( eventData.Entity is RealityPlayer )
			return;
